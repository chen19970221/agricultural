...
// //     arr.forEach(function(item){
// //       let product = item.作物名稱
// //       let content = arr.filter((item) => searchText == product)

// //       function filterItems(product){
// //         return product.filter((el) => el.toLowerCase().includes(searchText.toLowerCase()))
// //       }
// //       console.log(filterItems(product))
// //     })
// //     // showList.innerHTML = ""
// //   })
// // }
